...
[program] Из вершины 0 можно попасть в вершины:  1 2
[program] Из вершины 1 можно попасть в вершины:  2 0
[program] Из вершины 2 можно попасть в вершины:  0 1
...
[program] Сейчас требования по посещ.вершинам выглядят так:
...
[program] Сейчас в этих токах обновляется инвентарь так:
...
[program] Переход из вершины 1 в вершину 2 (индексация с нуля) сопровождается текстом:
[program] "Переход из вершины 2 в вершину 3"
[program] Введите количество текстов для кнопочек, которое вы хотите добавить: [user] 0
```
___